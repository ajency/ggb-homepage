												...
												<div id="product-qEjBZmgcv14tAuCCkvmB" class="custom-col-12 col-lg-12 product-list-item p-lg-0 effect trigger5 my-6">
												    <div class="product-wrapper cardfive">
												        <div class="lg-w-50 hover-text">
												            ...
												            <div class="product-content  pb-4">
												                <h4 class="font-weight-light font-size-18 mt-0 mb-lg-0">Barley, mix of lettuce and lightly bitter amaranth leaves (tambdi bhaji), red cabbage, cucumber, capsicum and carrots. Our sour-ish pickled chillies (made in-house) play their part well alongside mango (alphonso) chunks and the mint mustard dressing. Flax seeds for crunch.\r\n    Choose between the veg/ vegan bowl that comes with brown chickpeas (kaala chana).</h4>
												            </div>
												        </div>
												        <div class="product-image">
												            <div class="slick-slideshow__slide">
												...
												<div id="product-vXoakmxssdJG1M8DRrMF" class="custom-col-12 col-lg-12 product-list-item p-lg-0 effect trigger5 my-6">
												    <div class="product-wrapper cardfive">
												        <div class="lg-w-50 hover-text">
												            ...
												            <div class="product-content  pb-4">
												                <h4 class="font-weight-light font-size-18 mt-0 mb-lg-0">Barley, mix of lettuce and lightly bitter amaranth leaves (tambdi bhaji), red cabbage, cucumber, capsicum and carrots. Our sour-ish pickled chillies (made in-house) play their part well alongside mango (alphonso) chunks and the mint mustard dressing. Flax seeds for crunch.\r\n    The non veg bowl comes with prawns.</h4>
												            </div>
												        </div>
												        <div class="product-image">
												            <div class="slick-slideshow__slide">
												...
												<div id="product-o8DaHCRxfYBIJQ5W7kCB" class="custom-col-12 col-lg-12 product-list-item p-lg-0 effect trigger5 my-6">
												    <div class="product-wrapper cardfive">
												        <div class="lg-w-50 hover-text">
												            ...
												            <div class="product-content  pb-4">
												                <h4 class="font-weight-light font-size-18 mt-0 mb-lg-0">Buckwheat noodles, greens, roasted vegetables and sweet-spiced tofu / paneer / chicken. Tossed together, salad style, in a very Asian soy-sesame ginger dressing. Completed with a generous topping of sesame seeds and roasted groundnuts.</h4>
												            </div>
												        </div>
												        <div class="product-image">
												            <div class="slick-slideshow__slide">
...
<!-- 												<div id="product-QexP4xy4W2cMx4zORNEi" class="custom-col-12 col-lg-12 product-list-item p-lg-0 effect trigger5 my-6">
												...
												<div id="product-vXoakmxssdJG1M8DRrMF" class="custom-col-12 col-lg-12 product-list-item p-lg-0 effect trigger5 my-6">
												    <div class="product-wrapper cardfive">
												        <div class="lg-w-50 hover-text">
												            <h3 class="product-title h1 font-weight-bold mb-2 mb-lg-3 mt-lg-1 p-title">Mango Barley Bowl (Prawns)</h3>
												            <div class="product-content  pb-4">
												                <h4 class="font-weight-light font-size-18 mt-0 mb-lg-0">The Mango Barley Bowl comes with barley, mix of lettuce and lightly bitter amaranth leaves, red cabbage, cucumber, capsicum and carrots. Our sour-ish pickled chillies (made in-house) play their part well alongside the mint mustard dressing. <br>Prawns add a lovely balance to the sweetness of the mangoes (alphonso). Flax seeds for crunch.</h4>
												            </div>
												        </div>
												        <div class="product-image">
												            <div class="slick-slideshow__slide">
	...
	<script src="https://order.greengrainbowl.com/site/react-components.1592209389717.js" type="text/javascript"></script>
	
	<!-- Global variables for react cart app component and css  hash -->
	<script>
		var react_js_file_hashes = {"2":"c2a15300","runtime-main":"9efbcb05","main":"62272cfe","react-components":"1592209389717"};
		var react_css_file_hashes = {"main":"835707e6"};
