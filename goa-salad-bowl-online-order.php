...
<!-- 					<figure class="block-image text-center">
  ...
  <div class="bounce3"></div>
	...
	<script src="https://order-staging.greengrainbowl.com/site/react-components.1593086386955.js" type="text/javascript"></script>
	
	<!-- Global variables for react cart app component and css  hash -->
	<script>
		var react_js_file_hashes = {"2":"4535aed7","runtime-main":"9efbcb05","main":"638addbd","react-components":"1593086386955"};
