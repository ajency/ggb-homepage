...
<head>
	...
	fbq('init', '421963332335926');
	fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none"
	src="https://www.facebook.com/tr?id=421963332335926&ev=PageView&noscript=1"
	/></noscript>
										...
										?>
									 	...
									 	<div id="panels" class="panels">
											<section class="toggle-wrapper pt-0 pb-1">
												...
												<?php }?>
						    				<div id="NoBowls" class="row product-list m-auto panel" data-days_available="">
