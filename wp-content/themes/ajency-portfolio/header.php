...
<!--
    ...
    <?php if (is_page_template('goa-salad-bowl-online-order-v1.php')) { ?><link href="<?php echo get_template_directory_uri(); ?>/css/customized.css" rel="stylesheet" type="text/css"/>
    <?php } ?>
    <?php if (!is_page_template('goa-salad-bowl-online-order-v1.php')) { ?><link href="<?php echo get_template_directory_uri(); ?>/css/custom.css" rel="stylesheet" type="text/css"/>
    <?php } ?>
    ...
    <?php if (is_page_template('archive.php') || is_singular('post') || is_page_template('template-blogs.php') || is_page_template('template-fullwidth.php') || is_page_template('template-all_blogs.php') || !is_page_template('goa-salad-bowl-online-order-v1.php')) { ?>
